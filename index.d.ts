declare module "finity-esm" {
	...
	export interface StateMachineConfigurator<S, E>
		extends BaseConfigurator<S, E> {
	...
	export interface GlobalConfigurator<S, E>
		...
		onUnhandledEvent(
			hook: UnhandledEventHook<S, E>
		): GlobalConfigurator<S, E>;
	}
	...
	export interface TimerConfigurator<S, E>
		extends TriggerConfigurator<S, E> {}
